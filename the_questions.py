riddles = [
        ...
        ("A Bosnian Serb civilian, assassinated Archduke Franz Ferdinand and his wife. Which caused WW1?",
         "Gavril Principe"),
        ("Inside our bodies we have origins, but one is very important that's keeping us alive without it we might die?",
         "The Heart"),
        ("If you ever encounter a horde of 100,000,000 zombies what would you do?", "Run away")
    ]

# Add more question if you like